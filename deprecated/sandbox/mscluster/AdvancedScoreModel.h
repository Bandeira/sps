...
public:
	...
	AdvancedScoreModel() : ind_was_initialized(false) {}
	...
	void *get_cumulative_seq_prob_model_ptr(int tag_length) { return cumulative_seq_prob_models[tag_length]; }
...
protected:
	...
	void *cumulative_seq_prob_models[10]; // model 0 is for de novo, the others are for tags
