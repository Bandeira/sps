...
$kfm->defaultSetting('listview',1);
$kfm->defaultSetting('preferred_languages',array('en'));
//contextmenu
...
$kfm->defaultSetting('allow_directory_create',0);
$kfm->defaultSetting('allow_directory_delete',0);
$kfm->defaultSetting('allow_directory_edit',0);
...
$kfm->defaultSetting('allow_file_edit',0);
$kfm->defaultSetting('allow_file_move',0);
...
// depricated
$kfm->defaultSetting('allow_image_manipulation',0); // this is plugin management
