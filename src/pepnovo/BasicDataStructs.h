...
struct Node {
	Node() : mass(-1.0), org_peak_mass(-1.0), orig_peak_offset(-1.0), orig_peak_orient(-1), orig_peak_charge(-1), score(0), const_score(NEG_INF), tmp_score(NEG_INF), log_rank(999999), idx_max_in_score_node(-1), 
	...
	mass_t mass;
	mass_t org_peak_mass;
	mass_t orig_peak_offset;
	int orig_peak_charge;
	int orig_peak_orient;
	score_t score;
