...
int main(int argc, char **argv){
	...
	// Filter by p-value
	if(params.paramPresent("MIN_PVALUE")) {
	    cout << "Filtering by p-value <= "<<params.getValueDouble("MIN_PVALUE")<<"..."; cout.flush();
		float revPvalue = 1-(float)params.getValueDouble("MIN_PVALUE");
