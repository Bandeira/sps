...
namespace specnets
{
    ...
    class SpectralLibrary : public SpecSet
    {
        public:
            ...
            virtual int search(Spectrum &query_spec, PeptideSpectrumMatchSet &output_psms, float parentmass_tolerance, int top_hits);
            ...
            int search_target_decoy_specset_SLGFProjection(SpectralLibrary &decoy, 
                                                                         SpecSet searchable_spectra,
                                                                         float parentmz_tolerance, 
                                                                         vector<Spectrum *> target_library_ptr, 
                                                                         vector<Spectrum *> decoy_library_ptr,
            ...
            int search_target_decoy_SLGFProjection(SpectralLibrary &decoy, 
                                             Spectrum query_spec, 
                                             psmPtr output_psm, 
                                             float parentmz_tolerance,
                                             vector<Spectrum *> target_library_ptr, 
