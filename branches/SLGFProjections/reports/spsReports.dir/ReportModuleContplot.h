#ifndef __REPORT_MODULE_CONTPLOT_H__
#define __REPORT_MODULE_CONTPLOT_H__
 ...
 */
class ReportModuleContplot : public ReportModuleBase {
 ...
 public:
   ...
   */
  ReportModuleContplot(const ParameterList & inputParams);

  //@}

  //! \name DESTRUCTOR
  //@{
  virtual ~ReportModuleContplot(void);
  //@}
  ...
  virtual bool getData(string &data) {contplot.getData(data);}; //{data = m_image;}; //

  virtual bool setData(int type, void *data) {contplot.setData(type, data);};
...
private:
  ...
  //! \name NOT IMPLEMENTED
  //@{
  ReportModuleContplot(const ReportModuleBase & that);
  //@}
};
