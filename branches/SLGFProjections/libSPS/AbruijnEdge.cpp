...
namespace abruijn
{
  ...
  AbruijnEdge::AbruijnEdge(const AbruijnEdge& other) :
    Edge((const Edge&)other), m_mass(other.m_mass), m_fLabel(other.m_fLabel),
        m_jumpLabel(other.m_jumpLabel), m_rLabel(other.m_rLabel),
        m_isCorrect(other.m_isCorrect), m_isAnnotated(other.m_isAnnotated),
        m_modified(other.m_modified), m_specIDs(other.m_specIDs),
        m_expandOnly(other.m_expandOnly), m_rWeight(other.m_rWeight)
  {
  }
  ...
  {
    AbruijnEdge* otherPtr = castEdgePtr(&otherEdge);
    AbruijnEdge& other = *otherPtr;

    Edge::copy((Edge&)other);
