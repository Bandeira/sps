...
namespace abruijn
{
  ...
  public:
    ...
    static const double MULTI_EDGE_PENALTY;

    static const unsigned int PATH_EXPAND_LIMIT;
    ...
    AbruijnGraph(AbruijnGraph& other);
    ...
    void loadAssembly(const pair<pair<vector<int> , vector<int> > , vector<
  ...
  protected:
    ...
    void expandAllPaths(const bool& goReverse);
