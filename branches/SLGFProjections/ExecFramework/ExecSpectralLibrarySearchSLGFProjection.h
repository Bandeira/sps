#ifndef __ExecSpectralLibrarySearchSLGFProjection_H__
#define __ExecSpectralLibrarySearchSLGFProjection_H__
...
namespace specnets
{
   ...
   */
  class ExecSpectralLibrarySearchSLGFProjection : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
    /*! \brief The exemplar constructor.
     ...
     @sa clone()
     */
    ExecSpectralLibrarySearchSLGFProjection(void);
     ...
     */
    ExecSpectralLibrarySearchSLGFProjection(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecSpectralLibrarySearchSLGFProjection(void);
    //@}
