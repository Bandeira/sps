...
namespace specnets
{
  ...
  public:
    ...
    static bool
    loadSpecsetMultiple(const string& specFilePaths, SpecSet* spectra, vector<
        string>* fileNames = 0, vector<pair<int, int> >* fileSpecIdxs =
        0, const char* separator = ";");

    static bool loadSpecset(const string& specFilePath,
                            SpecSet* spectra,
  ...
  private:
    ...
    list<pair<string, int> >* m_recordedInput;
    list<pair<string, int> >* m_recordedOutput;
