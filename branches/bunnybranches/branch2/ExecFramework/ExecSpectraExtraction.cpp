...
namespace specnets
{
  ...
  ExecSpectraExtraction::ExecSpectraExtraction(const ParameterList & inputParams){
    ...
    if(inputParams.getValueInt("CCMS", 0) == 1){
        input_spectra_data_file = input_spectra_data_file + "/00000.txt";
    }
  ...
  bool ExecSpectraExtraction::loadInputData(void){
    ...
    if(!input_spectra_metadata.is_open()){
        ...
        while(input_spectra_metadata.good()){
            ...
            InChI_Aux = remove_char(ion_mode, '\r');
            InChI_Aux = remove_char(ion_mode, '\n');
            ...
            for(int i = 0; i < specs.size(); i++){
                if( (specs[i].scan == extract_scan || extract_scan == ExecSpectraExtraction::ALL ) && specs[i].msLevel == 2 ){
                    ...
                    new_annotations_string<<extracted_spec.psmList.front()->m_organism[extracted_spec.psmList.front()->m_organism.size()-1]<<"\t";
                    new_annotations_string<<extracted_spec.psmList.front()->m_smiles[extracted_spec.psmList.front()->m_smiles.size()-1]<<"\t";
                    new_annotations_string<<extracted_spec.psmList.front()->m_InChI[extracted_spec.psmList.front()->m_InChI.size()-1]<<"\t";
                    new_annotations_string<<extracted_spec.psmList.front()->m_InChI_Aux[extracted_spec.psmList.front()->m_InChI_Aux.size()-1]<<"\t";
                    new_annotations_string<<extracted_spec.spectrum_quality<<"\t";
                    new_annotations_string<<extracted_spec.psmList.front()->m_compound_name[extracted_spec.psmList.front()->m_compound_name.size()-1]<<"\t";
    ...
    for(int library_idx = 0; library_idx < extracted_specs.size(); library_idx++){
      ...
      all_annotations_string<<extracted_specs[library_idx].psmList.front()->m_organism[extracted_specs[library_idx].psmList.front()->m_organism.size()-1]<<"\t";
      all_annotations_string<<extracted_specs[library_idx].psmList.front()->m_smiles[extracted_specs[library_idx].psmList.front()->m_smiles.size()-1]<<"\t";
      all_annotations_string<<extracted_specs[library_idx].psmList.front()->m_InChI[extracted_specs[library_idx].psmList.front()->m_InChI.size()-1]<<"\t";
      all_annotations_string<<extracted_specs[library_idx].psmList.front()->m_InChI_Aux[extracted_specs[library_idx].psmList.front()->m_InChI_Aux.size()-1]<<"\t";
      all_annotations_string<<extracted_specs[library_idx].spectrum_quality<<"\t";
      all_annotations_string<<extracted_specs[library_idx].psmList.front()->m_compound_name[extracted_specs[library_idx].psmList.front()->m_compound_name.size()-1]<<"\t";
