#ifndef __ExecSpectralLibrarySearch_H__
#define __ExecSpectralLibrarySearch_H__
...
namespace specnets
{
   ...
   */
  class ExecSpectralLibrarySearch : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
    /*! \brief The exemplar constructor.
     ...
     @sa clone()
     */
    ExecSpectralLibrarySearch(void);
     ...
     */
    ExecSpectralLibrarySearch(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecSpectralLibrarySearch(void);
    //@}
  ...
  private:
    ...
    std::string m_output_psm_topk_filename;
