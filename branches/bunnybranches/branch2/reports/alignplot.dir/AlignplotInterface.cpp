...
namespace specnets {
///////////////////////////////////////////////////////////////////////////////
AlignplotInterface::AlignplotInterface()
{
...
///////////////////////////////////////////////////////////////////////////////
int AlignplotInterface::plot(void)
{
...
///////////////////////////////////////////////////////////////////////////////
int AlignplotInterface::processOptions(int argc, char **argv)
{
  //--------------------------------------------------------------------------------------------
...
////////////////////////////////////////////////////////////////////////////////
int AlignplotInterface::processOptions(ParameterList &ip)
{
  ParameterList commandLineParams;
  ...
  if (commandLineParams.exists("CONTIG")) {
    ...
    cerr << "Error: contig index not specified." << endl;
    return -1;
  }
  ...
  if (commandLineParams.exists("ABRUIJN")) {
    ...
    cerr << "Error: Abruijn graph not specified." << endl;
    return -1;
  }
  ...
  if (commandLineParams.exists("STAR")) {
    ...
    star.LoadSpecSet_pklbin(starFilename.c_str());
    plotContig.setStar(&star);
  } else {
    cerr << "Error: Star spectra file not specified." << endl;
    return -1;
  }
  ...
  if (commandLineParams.exists("SEQS")) {
    ...
    seqs.LoadSpecSet_pklbin(starFilename.c_str());
    plotContig.setSeqs(&seqs);
  } else {
    cerr << "Error: Seqs file not specified." << endl;
    return -1;
  }
...
///////////////////////////////////////////////////////////////////////////////
int AlignplotInterface::help(ostream & sout)
{
  version(sout);
...
///////////////////////////////////////////////////////////////////////////////
int AlignplotInterface::version(ostream & sout)
{
...
///////////////////////////////////////////////////////////////////////////////
int AlignplotInterface::error(const string & a)
{
