...
int ReportInterface::buildTables(ReportGeneratorData &data)
{
  ...
  tProtein.saveTable(FILE_SEPARATOR_TSV);
  tProteinCoverage.saveTable(FILE_SEPARATOR_TSV);
  tContig.saveTable(FILE_SEPARATOR_TSV);
  tCluster.saveTable(FILE_SEPARATOR_TSV);
  tInputSpectra.saveTable(FILE_SEPARATOR_TSV);
