...
////////////////////////////////////////////////////////////////////////////////
bool FilenameManager::checkExtension(void)
{
  if(
    extension.compare("pklbin") == 0 ||
    extension.compare("mgf") == 0 ||
    extension.compare("pkl") == 0 ||
    extension.compare("ms2") == 0 ||
    extension.compare("prmsv3") == 0 ||
    extension.compare("prms") == 0 ||
    extension.compare("mzxml") == 0 ||
    extension.compare("mzml")== 0
    )
    return true;
                                 ...
                                 bool sort)
{
  ...
  for (struct stat cs; pe = readdir(pd);)
  {
    ...
    if (str.compare(0, prefix.length(), prefix) == 0
        && str.compare(aux.length() - sufix.length(), sufix.length(), sufix)
            == 0)
    {
