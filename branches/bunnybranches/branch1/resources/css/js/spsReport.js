...
var PAGE_FIELD_ALLOW_REALIGN      = "allowRealign";
...
////////////////////////////////////////////////////////////////////////////////
ReportTables.prototype.addBarLink = function(out, func, img, text, doubleSpace)
{
  var sep = "&nbsp;&nbsp;&nbsp;";
...
ReportTables.prototype.setNavigationButtons = function()
{
  var out2 = createReference("");

  if(this.pageQueueLocation > 0)
    this.addBarLink(out2, "TablesAll.goBack();", iconArrowLeft1, "");
  else
    this.addBarLink(out2, "", iconArrowLeft2, "");

  if(this.pageQueueLocation < this.pageQueue.length  - 1)
    this.addBarLink(out2, "TablesAll.goForward();", iconArrowRight1, "", true);
  else
    this.addBarLink(out2, "", iconArrowRight2, "", true);

  var field = document.getElementById('navButtons');
  if(field)
    field.innerHTML = out2;
}
////////////////////////////////////////////////////////////////////////////////
...
renderer.prototype.paginate = function(out, out2, tab, functionName, start)
{
  ...
  while(pos >= 0) {
    ...
    var endIndex = k + PAGE_LENGTH - 1;
    var j = tab.peek(endIndex);
