...
namespace specnets
{
  ...
  bool ExecFilterStarPairs::loadInputData(void)
  {
    ...
    if (!m_starSpectra->LoadSpecSet_pklbin(starsFilename.c_str()))
    {
  ...
  bool ExecFilterStarPairs::saveInputData(std::vector<std::string> & filenames)
  {
    ...
    {
      m_starSpectra->SaveSpecSet_pklbin(starsFilename.c_str());
    }
  ...
  bool ExecFilterStarPairs::saveOutputData(void)
  {
    ...
    {
      m_matchedPeaks->SaveSpecSet_pklbin(m_params.getValue("OUTPUT_SPECS").c_str());
    }
    else if (m_params.exists("OUTPUT_SPECS_PKLBIN"))
    {
      m_matchedPeaks->SaveSpecSet_pklbin(m_params.getValue("OUTPUT_SPECS_PKLBIN").c_str());
    }
  ...
  bool ExecFilterStarPairs::loadOutputData(void)
  {
    ...
    if (m_params.exists("OUTPUT_SPECS"))
    {
      if (!m_matchedPeaks->LoadSpecSet_pklbin(m_params.getValue("OUTPUT_SPECS").c_str()))
      {
