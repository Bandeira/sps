...
#include "ExecSpectralLibraryUnannotatedSearch.h"
...
namespace specnets
{
  ...
  void ExecModuleFactory::RegisterAllModules( void )
  {
    ...
    Register( ExecCreateSpectralLibrary().getName(), new ExecCreateSpectralLibrary() );
...
//    Register( ExecMainSpecnets().getName(), new ExecMainSpecnets() );
    ...
    Register( ExecMergePaired().getName(), new ExecMergePaired() );
    ...
    Register( ExecProjectionStatistics().getName(), new ExecProjectionStatistics() );
...
//    Register( ExecSpecNetsPropagation().getName(), new ExecSpecNetsPropagation() );
    ...
    Register( ExecSpectralLibraryDecoyCreation().getName(), new ExecSpectralLibraryDecoyCreation());
    Register( ExecSpectralLibraryUnannotatedSearch().getName(), new ExecSpectralLibraryUnannotatedSearch());
};
