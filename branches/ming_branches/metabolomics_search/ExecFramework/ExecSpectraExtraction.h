#ifndef __ExecSpectraExtraction_H__
#define __ExecSpectraExtraction_H__
...
namespace specnets
{
   ...
   */
  class ExecSpectraExtraction : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
     ...
     */
    ExecSpectraExtraction(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecSpectraExtraction(void);
    //@}
  ...
  private:
    ...
    std::string existing_library_name;
