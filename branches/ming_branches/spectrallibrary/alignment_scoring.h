...
namespace specnets
{
	 ...
	 *@return
	 */
	int FindMatchPeaksAll(Spectrum &spec1, Spectrum &spec2, float shift,
	 ...
	 *@return
	 */
	int FindMatchPeaksAll2(Spectrum &spec1, Spectrum &spec2, float shift,
			float tolerance, vector<int> &idx1, vector<int> &idx2);
	 ...
	 *@param minAbsShift
	 */
	TwoValues<int> computeShifts(Spectrum &spec1, Spectrum &spec2, float peakTol,
			float pmTol, float minRatio, float minPeakAreaOvlp,
			int minNumMatchedPeaks, AAJumps &validJumps,
	...
	void computeShiftsRaw(Spectrum& spec1, Spectrum& spec2, float shiftOffset, map<int, list<TwoValues<int> > >& shifts, unsigned int minNumMatchedPeaks, bool usePPM = false);
	 ...
	 *@return
	 */
	float ScoreOverlap6(Spectrum &spec1, Spectrum &spec2, float shift,
	 ...
	 *@return
	 */
	float ScoreOverlap6mp(Spectrum &spec1, vector<int> idx1all, Spectrum &spec2,
