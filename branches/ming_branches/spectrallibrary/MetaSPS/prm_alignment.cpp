...
namespace specnets
{
                                                                 ...
                                                                 vector<float> >* alignedScores) const
  {
    ...
    MZRange endPt1(spectrum1->parentMass - AAJumps::massHion, 0, spectrum1->getTolerance(0));
    MZRange endPt2(spectrum2->parentMass - AAJumps::massHion, 0, spectrum2->getTolerance(0));
    ...
    for (int i = 0; i < szSpec1; i++) {
      range1.set((*spectrum1)[i][0], (*spectrum1)[i][1], spectrum1->getTolerance(i));
