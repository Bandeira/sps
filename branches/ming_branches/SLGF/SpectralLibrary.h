...
namespace specnets
{
    ...
    class SpectralLibrary : public SpecSet
    {
        public:
            ...
            int search_target_decoy_specset(SpectralLibrary &decoy, 
            ...
            int remove_low_complexity_spectra(SpectralLibrary &decoy, MS2ScoringModel &model, vector<string> &ionsToExtract,string allIons);
        ...
        protected:
            ...
            void filter_best_representative(MS2ScoringModel &model,
                                            vector<string> &ionsToExtract,
                                            string allIons);
            void filter_simple_spectra( MS2ScoringModel &model,
                                        vector<string> &ionsToExtract,
                                        string allIons);
