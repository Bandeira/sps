...
namespace specnets
{
  ...
  void PeptideSpectrumMatch::internalCopy(const PeptideSpectrumMatch &other)
  {
    ...
    for(int submission_idx = 0; submission_idx < other.m_submission_metadata.size(); submission_idx++){
        m_submission_metadata.push_back(other.m_submission_metadata[submission_idx]);
        m_organism.push_back(other.m_organism[submission_idx]);
        m_compound_name.push_back(other.m_compound_name[submission_idx]);
        m_smiles.push_back(other.m_smiles[submission_idx]);
        m_InChI.push_back(other.m_InChI[submission_idx]);
        m_InChI_Aux.push_back(other.m_InChI_Aux[submission_idx]);
    }
