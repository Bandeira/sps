...
namespace specnets
{
  ...
  public:
    ...
    /**
     * Extracts spectra matching a fragmentation method
     * @param outputSpecs
     * @param fragType
     * @return true if spectra matching the fragmentation type could be found, false if not
     */
    bool extractSpectra(SpecSet& outputSpecs, Spectrum::FragType& fragType);
     ...
     *@return
     */
    unsigned int LoadSpecSet_prmsv3(const char *filename, vector<vector<string> >* prmOrigins = 0);
