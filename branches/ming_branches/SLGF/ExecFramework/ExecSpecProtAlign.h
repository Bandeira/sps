...
namespace specnets
{
  ...
  public:
    ...
    /*! \brief Constructor which takes both the parameters and the data structures
     ...
     @sa validateParams()
     @param inputParams structure containing all input parameters necessary for execution
     @param contigs Input spectra as contigs
  ...
  private:
  	Clusters * m_contigs; //! Input spectra as contigs
	  ...
	  SpecSet * m_matchedSpectra; //! Matched versions of spectra significantly matched to a protein
	  vector<unsigned int> * m_matchedSpectraIndices; //! Indices of spectra significantly matched to a protein (if non-NULL and of same size as m_contigs)
