                    ...
                    SpecSet & outputSpectra)
{
  ...
  scoringParams.setValue("OUTPUT_SPECTRA", "spectra/specs_scored.pklbin");
  scoringParams.setValue("PEPNOVO_INPUT_MGF", "spectra/specs_ms.mgf");
  scoringParams.setValue("PEPNOVO_OUTPUT_PRMS", "spectra/specs_scored.prms");
