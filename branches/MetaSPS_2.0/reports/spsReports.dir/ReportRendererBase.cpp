...
////////////////////////////////////////////////////////////////////////////////
int ReportRendererBase::renderReport(ReportBase *report, ostream &outstream, int start, int count)
{
...
///////////////////////////////////////////////////////////////////////////////
string ReportRendererBase::translateTag(const string &tag, vector<string> *row, int add)
{
  // set default return value
  string ret = "";
  //ret = tagOpen;
