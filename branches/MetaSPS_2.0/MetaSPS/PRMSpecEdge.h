...
public:
	...
	static void appendEdges(PRMSpecEdge* edge1, PRMSpecEdge* edge2, PRMSpecEdge* outEdge1Plus2);
	...
	PRMSpecEdge(const int idx, const SpectrumPair& specPair,
	...
	void initializeEdge(const int idx, const SpectrumPair& specPair,
			const SpecSet& spectra);
