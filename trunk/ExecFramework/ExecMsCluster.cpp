...
{
  //if(m_combinedSpecSet) {
  //  stringstream aux;
  //  for(int i = 0 ; i < m_combinedSpecSet->size() ; i++) {
  //    aux << " [" << i << " : ";
  //    for(int j = 0 ; j < (*m_combinedSpecSet)[i].size() ; j++) {
  //      aux << " (" << (*m_combinedSpecSet)[i][j][0] << " ; " << (*m_combinedSpecSet)[i][j][0] << ") ";
  //    }
  //    aux << "]";
  //  }
  //  DEBUG_MSG("m_combinedSpecSet : " << aux.str());
  //}
