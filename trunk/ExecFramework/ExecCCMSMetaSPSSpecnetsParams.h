#ifndef __ExecCCMSMetaSPSSpecnetsParams_H__
#define __ExecCCMSMetaSPSSpecnetsParams_H__
...
namespace specnets
{
   ...
   */
  class ExecCCMSMetaSPSSpecnetsParams : public ExecBase
  {
  public:
    //! \name CONSTRUCTORS
    //@{
    /*! \brief The exemplar constructor.
     ...
     @sa clone()
     */
    ExecCCMSMetaSPSSpecnetsParams(void);
     ...
     */
    ExecCCMSMetaSPSSpecnetsParams(const ParameterList & inputParams);
    ...
    //! \name DESTRUCTOR
    //@{
    virtual ~ExecCCMSMetaSPSSpecnetsParams(void);
    //@}
