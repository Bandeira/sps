                     ...
                     vector<SpecSet>& loadedSpectra)
{
  ...
  for (unsigned int i = 0; i < filenames.size(); i++)
  {
    ...
    loadedSpectra[i].savePklBin(pklbinPath.c_str(), binPath.c_str());
...
bool performMergeOfCSPSAndGenoMS(ParameterList & ip)
{
  ...
  if (inputSpectra.loadPklBin("./homology/csps.contigs_midx.pklbin")
      <= 0)
  {
  ...
  if (inputSpectra.loadPklBin("./homology/csps.contigs_midx_all.pklbin")
      <= 0)
  {
  ...
  if (other.loadPklBin("./homology/genoms.contigs_midx_all.pklbin")
      <= 0)
  {
  ...
  inputSpectra.appendSpecSet(other);
  if (inputSpectra.savePklBin("./homology/contigs_midx_all.pklbin")
      <= 0)
  {
  ...
  if (inputSpectra.loadPklBin("./homology/csps.homglue_ref_midx.pklbin")
      <= 0)
  {
  ...
  if (other.loadPklBin("./homology/genoms.homglue_ref_midx.pklbin")
      <= 0)
  {
  ...
  inputSpectra.appendSpecSet(other);
  if (inputSpectra.savePklBin("./homology/homglue_ref_midx.pklbin")
      <= 0)
  {
  ...
  if (inputSpectra.loadPklBin("./homology/csps.homglue_matches.pklbin")
      <= 0)
  {
  ...
  if (other.loadPklBin("./homology/genoms.homglue_matches_midx.pklbin")
      <= 0)
  {
  ...
  inputSpectra.appendSpecSet(other);
  if (inputSpectra.savePklBin("./homology/homglue_matches_midx.pklbin")
      <= 0)
  {
                      ...
                      bool decoy)
{
  ...
  DEBUG_TRACE;
  ExecTagSearch moduleTagsearch(tagsearchParams, &spectra, &db, specsToSearch, &psmSet);
  DEBUG_TRACE;
                            ...
                            bool resume)
{
  ...
  specProtAlignParams.setValue("GRID_EXECUTION_FLAG", gridExecutionFlag ? "1" : "0");
  ...
  specProtAlignParams.setValue("GRID_DATA_DIR_TARGET", getProjPath(ip, "./homology/grid_t"));
  specProtAlignParams.setValue("GRID_DATA_DIR_DECOY", getProjPath(ip, "./homology/grid_d"));
  ...
  specProtAlignParams.setValue("OUTPUT_MATCHED_PEAKS_IDX_TGT",
                               getProjPath(ip, "homology/contigs_midx_tgt.pklbin"));
  ...
  specProtAlignParams.setValue("OUTPUT_MATCHED_PEAKS_IDX_DEC",
                               getProjPath(ip, "homology/contigs_midx_dec.pklbin"));
  ...
  specProtAlignParams.setValue("OUTPUT_PSM_MOD_FREQS",
                               getProjPath(ip, "homology/contigs_psm_mod_freqs.txt"));
  ...
  DEBUG_TRACE;
  ExecSpecProtAlignTgtDecoy moduleSpecProtAlignTgtDecoy(
                                        specProtAlignParams,
                                        &contigSpectra,
                                        &db,
                                        &dbDecoy,
                            ...
                            bool resume)
{
  ...
  specProtAlignParams.addIfExists(ip, "GRID_SGE_EXE_DIR");
  specProtAlignParams.addIfExists(ip, "GRID_PARAMS");
  specProtAlignParams.setValue("GRID_DATA_DIR_TARGET", getProjPath(ip, "./homology/grid2_t"));
  specProtAlignParams.setValue("GRID_DATA_DIR_DECOY", getProjPath(ip, "./homology/grid2_d"));
  ...
  cout << "FDR_SPECTRUM_THRESHOLD = " << ip.getValue("FDR_SPECTRUM_THRESHOLD") << endl;
  ...
  specProtAlignParams.setValue("OUTPUT_MATCHED_PEAKS_IDX_TGT",
                               getProjPath(ip, "homology/spectrum_midx_tgt.pklbin"));
  specProtAlignParams.setValue("OUTPUT_MATCHED_SPECS_TGT",
                               getProjPath(ip, "homology/spectrum_tgt.pklbin"));
  specProtAlignParams.setValue("OUTPUT_PSM_TGT",
                               getProjPath(ip, "homology/spectrum_psm_tgt.txt"));
  specProtAlignParams.setValue("OUTPUT_MATCHED_PEAKS_IDX_DEC",
                               getProjPath(ip, "homology/spectrum_midx_dec.pklbin"));
  specProtAlignParams.setValue("OUTPUT_MATCHED_SPECS_DEC",
                               getProjPath(ip, "homology/spectrum_dec.pklbin"));
  specProtAlignParams.setValue("OUTPUT_PSM_DEC",
                               getProjPath(ip, "homology/spectrum_psm_dec.txt"));

  specProtAlignParams.setValue("OUTPUT_MATCHED_PEAKS_IDX",
                               getProjPath(ip, "homology/spectrum_midx.pklbin"));
  specProtAlignParams.setValue("OUTPUT_MATCHED_SPECS",
  ...
  specProtAlignParams.setValue("OUTPUT_PSM_FDR",
                               getProjPath(ip, "homology/spectrum_psm_fdr.txt"));
...
int main(int argc, char ** argv)
{
  ...
  else if (performClustering && clusterTool == CLUSTER_MSCLUST)
  {
    ...
    if (!ms2Spectra.loadPklBin(getProjPath(ip,
                                                   "./spectra/specs_ms.pklbin").c_str()))
    {
  ...
  else
  {
    ...
    if (!prmSpectra.loadPklBin(getProjPath(ip,
  ...
  if (penaltyAlign)
  {
    ...
    if (!penaltyMatrixBlosum.loadFromBlosum(blosumFilename)) {
  ...
  else
  {
    ...
    if (contigShifts.consensus.loadPklBin("assembly/old_sps_seqs.pklbin")
        <= 0
        and contigShifts.consensus.loadPklBin("assembly/sps_seqs.pklbin")
            <= 0)
    {
      ERROR_MSG("Problem encountered while skipping Assembly stage" );
      writeStatusFile(statusFileName, "Error");
  ...
  if (ip.exists("FASTA_DATABASE"))
  {
    ...
    if (ip.getValueFloat("FDR_CONTIG_THRESHOLD", -1.0) >= 0.0 || ip.getValueFloat("FDR_SPECTRUM_THRESHOLD", -1.0) >= 0.0) {
      psmSetTagDecoy.loadFromFile(getProjPath(ip, "assembly/tagsearchpsm_decoy.txt").c_str());
    }
    ...
    else
    {
      ...
      if (!psmSetContigDecoy.loadFromFile(getProjPath(ip, "homology/contigs_psm_dec.txt").c_str())) {
        ERROR_MSG("Problem encountered while skipping ContigProtAlign stage" );
        writeStatusFile(statusFileName, "Error");
        exit(-STAGE_CONTIGPROTALIGN);
      }
       ...
       if (matchedContigs[i].psmList.size() == 0) {
        ...
        for ( ; itr != itr_end; itr++) {
          ...
          for (int j = 0; j < outputAssembledShifts[scanIndex].size(); j++) {
           ...
           int spectrumMassShift = (int)outputAssembledShifts[scanIndex][j].m1;
